...
const Alert = () => {
  ...
  return alert && alert.status === "success" ? (
    <button
      className={`w-100 rounded-0 alert alert-success d-flex justify-content-center border border-3 position-absolute z-3`}
      onClick={clear}
    >
    ...
    <button
      className={`w-100 rounded-0 alert alert-danger d-flex justify-content-center border border-3 position-absolute z-3`}
      onClick={clear}
    >
